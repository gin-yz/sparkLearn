...
object CombineByKeyLearn {
  def main(args: Array[String]): Unit = {
    ...
    val value3: RDD[(String, (Int, Int))] = input.combineByKey((_, 1), (value: (Int, Int), v) => (value._1 + v, value._2 + 1), (value1: (Int, Int), value2: (Int, Int)) => (value1._1 + value2._1, value1._2 + value2._2))

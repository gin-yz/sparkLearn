//前面的依旧操作最后一步reduceByKey有ｓｈｆｆｕｌｅ，可以用累加器实现
...
object Required1_adv3 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 1. 读取原始日志数据
    val actionRDD = sc.textFile(Required1_adv3.getClass.getResource("./user_visit_action.txt").getFile)
